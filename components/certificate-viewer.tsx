...
export function CertificateViewer({
  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-8">
      ...
      <Card className="relative overflow-hidden border-none shadow-2xl bg-gradient-to-br from-white via-blue-50/20 to-purple-50/20 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20">
        {/* Decorative Background Pattern */}
        <div className="absolute inset-0 opacity-5 dark:opacity-10">
          <div className="absolute top-0 left-0 w-40 h-40 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full -translate-x-20 -translate-y-20 blur-3xl"></div>
          <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full translate-x-16 -translate-y-16 blur-2xl"></div>
          <div className="absolute bottom-0 left-0 w-36 h-36 bg-gradient-to-br from-green-500 to-emerald-500 rounded-full -translate-x-18 translate-y-18 blur-3xl"></div>
          <div className="absolute bottom-0 right-0 w-28 h-28 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-full translate-x-14 translate-y-14 blur-2xl"></div>
        </div>
        {/* Enhanced Golden Border */}
        <div className="absolute inset-6 border-4 border-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-400 dark:from-yellow-500 dark:via-yellow-400 dark:to-yellow-500 rounded-2xl opacity-60 shadow-inner"></div>
        <div className="absolute inset-4 border-2 border-gradient-to-r from-yellow-300 via-yellow-200 to-yellow-300 dark:from-yellow-400 dark:via-yellow-300 dark:to-yellow-400 rounded-3xl opacity-40"></div>
        <CardHeader className="relative text-center pt-16 pb-10 bg-gradient-to-b from-white/80 via-blue-50/30 to-purple-50/30 dark:from-gray-900/80 dark:via-blue-900/30 dark:to-purple-900/30">
          <div className="flex flex-col items-center mb-8">
            {/* Certificate Icon with Enhanced Glow */}
            <div className="relative mb-6">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 rounded-full blur-2xl opacity-50 scale-150"></div>
              <div className="relative w-24 h-24 bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 rounded-full flex items-center justify-center shadow-2xl ring-4 ring-white/50 dark:ring-gray-800/50">
            ...
            <div className="text-center space-y-4">
              <h1 className="text-6xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 dark:from-blue-400 dark:via-purple-400 dark:to-blue-400 bg-clip-text text-transparent mb-4 tracking-wide">
                SERTİFİKA
              </h1>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 font-medium tracking-wide mt-4">
                Başarı Belgesi
              </p>
            </div>
          </div>
        ...
        <CardContent className="relative p-16">
          ...
          <div className="text-center mb-12">
            <p className="text-2xl mb-8 text-gray-700 dark:text-gray-300 font-light tracking-wide">
              Bu belge,
            </p>

            {/* User Name with Elegant Styling */}
            <div className="relative inline-block mb-10">
              <h2 className="text-6xl font-bold bg-gradient-to-r from-gray-800 via-blue-800 to-gray-800 dark:from-gray-200 dark:via-blue-200 dark:to-gray-200 bg-clip-text text-transparent drop-shadow-sm">
                {certificateData.user_name}
              </h2>
              <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-4/5 h-1.5 bg-gradient-to-r from-transparent via-blue-500 to-transparent rounded-full"></div>
              <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-3/5 h-0.5 bg-gradient-to-r from-transparent via-purple-400 to-transparent rounded-full"></div>
            </div>

            <p className="text-2xl mb-10 text-gray-700 dark:text-gray-300 leading-relaxed max-w-3xl mx-auto font-light">
            ...
            <div className="relative mb-10">
              <div className="bg-gradient-to-r from-blue-50 via-white to-purple-50 dark:from-blue-900/30 dark:via-gray-800 dark:to-purple-900/30 border-2 border-blue-200 dark:border-blue-700 rounded-3xl p-8 shadow-xl relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-purple-500"></div>
                <h3 className="text-4xl font-semibold text-gray-800 dark:text-gray-200 mb-3">
                ...
                <div className="absolute bottom-0 right-0 w-24 h-24 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-full -translate-y-12 translate-x-12"></div>
              </div>
            </div>
            ...
            <div className="flex justify-center items-center space-x-8 mb-12">
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-emerald-400 rounded-2xl blur-lg opacity-40 group-hover:opacity-60 transition-opacity"></div>
                <div className="relative bg-gradient-to-r from-green-500 to-emerald-500 text-white px-8 py-4 rounded-2xl shadow-xl transform hover:scale-105 transition-transform">
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-400 rounded-2xl blur-lg opacity-40 group-hover:opacity-60 transition-opacity"></div>
                <div className="relative bg-gradient-to-r from-blue-500 to-purple-500 text-white px-8 py-4 rounded-2xl shadow-xl transform hover:scale-105 transition-transform">
      ...
      <div className="flex justify-center space-x-8">
        <Button
          ...
          size="lg"
          className="bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 hover:from-blue-600 hover:via-purple-600 hover:to-blue-600 text-white px-12 py-4 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 text-lg font-semibold"
        >
        ...
        <Button
          variant="outline"
          size="lg"
          className="border-2 border-gray-300 hover:border-blue-400 text-gray-700 hover:text-blue-600 px-12 py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-lg font-semibold bg-white hover:bg-blue-50"
        >
