        ...
        <div className="relative -mt-16 mb-8">
          <div className="flex mt-5 flex-col md:flex-row gap-6 items-start">
            <div className="relative z-10">
              <Image
                src={user.profile_picture || '/placeholder.svg?height=120&width=120'}
                alt="Profile picture"
                width={120}
                height={120}
            ...
            <div className="flex-1 mt-4 md:mt-16">
              ...
              <div className="grid grid-cols-4 gap-4 text-center">
                <div>
                  <div className="text-teal-500 font-bold text-xl">{user.community_count}</div>
                  <div className="text-xs text-gray-400">Topluluğa Üye</div>
                </div>
                <div>
                  <div className="text-teal-500 font-bold text-xl">{user.friend_count}</div>
                ...
                <div>
                  <div className="text-teal-500 font-bold text-xl">{user.event_count}</div>
