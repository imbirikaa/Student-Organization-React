...
export function UserPermissionViewer({ userId, communityId }: UserPermissionViewerProps) {
  ...
  const allPermissions = [
    'view_community', 'edit_community', 'delete_community',
    'view_members', 'approve_members', 'reject_members', 'remove_members', 'assign_roles',
    'view_events', 'create_events', 'edit_events', 'delete_events',
    'manage_registrations', 'view_registrations', 'approve_registrations', 'reject_registrations',
    'view_attendance', 'manage_attendance', 'generate_codes',
    'view_reports', 'manage_gallery', 'moderate_content',
    'send_notifications', 'manage_announcements', 'view_audit_logs'
  ]
            ...
            <div className="flex space-x-4">
              <div className="flex-1">
                ...
                <div className="flex space-x-2">
                  ...
                  />
                  <Button onClick={handleSearchByUserId} disabled={!searchUserId || loading}>
      ...
      {userPermissions.length > 0 ? (
          ...
          {userPermissions.map((userPerm, index) => (
            <Card key={index}>
              <CardHeader>
                ...
                <CardDescription>
                  Permissions for {userPerm.community.name} (Community ID: {userPerm.communityId})
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div>
                  <h4 className="font-medium mb-4 flex items-center space-x-2">
                    ...
                    <span>Permissions ({userPerm.permissions.length}/{allPermissions.length})</span>
                  </h4>
                ...
                <div className="p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="text-sm text-blue-800">
                    <p>• Total permissions: {userPerm.permissions.length} out of {allPermissions.length}</p>
                    <p>• Role: {userPerm.role.role} - {userPerm.role.description}</p>
        ...
        <Card>
          <CardContent className="text-center py-8">
            ...
            <p className="text-sm text-gray-400">Search for a user to view their permissions</p>
          </CardContent>
        </Card>
      )}
    </div>
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">View detailed permissions for any user in the community</p>
      </div>
