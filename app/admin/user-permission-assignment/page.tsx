    ...
    System: [
      {
        ...
        description: "Denetim günlükleri görüntüleme",
      },
    ],
  };
      ...
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Assign roles and individual permissions to community members
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage roles and permissions for members in Community{" "}
              {selectedCommunityId}
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        >
          <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Assign or remove individual permissions for{" "}
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="flex items-center space-x-4">
                  <Badge
                    className={
                      selectedMember
                        ? getRoleColor(selectedMember.role.role)
                        : ""
                    }
                  >
                    {selectedMember?.role.role}
                ...
                {Object.entries(availablePermissions).map(
                  ([category, permissions]) => (
                    <div key={category} className="border rounded-lg p-4">
                      <h5 className="font-medium mb-3 text-sm text-gray-700">
                        {category}
                      </h5>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {permissions.map((permission) => {
                          const isCurrentlyAssigned =
                            userDirectPermissions.includes(permission.name);
                          const isSelected = selectedPermissions.includes(
                            permission.name
                          );
                          const willBeRemoved = permissionsToRemove.includes(
                            permission.name
                          );
                          const finalState = isCurrentlyAssigned
                            ? !willBeRemoved
                            : isSelected;
