...
export default function AdminNavigationPage() {
  ...
  const adminFeatures: AdminFeature[] = [
    ...
    },
    {
      ...
      description:
        "Comprehensive role and permission management for communities",
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {adminFeatures.map((feature) => {
          const hasAccess = feature.communitySpecific
            ? currentCommunityId
              ? hasPermission(currentCommunityId, feature.permission)
              : false
      ...
      {currentCommunityId && (
        <div className="bg-blue-50 p-4 rounded-lg">
          <p className="text-sm text-blue-800">
            <strong>Current Community Context:</strong> Community{" "}
            {currentCommunityId}
          </p>
