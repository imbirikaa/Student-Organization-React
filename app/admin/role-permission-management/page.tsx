...
import { Search, UserPlus, Shield, Users, Settings, Trash2, Edit } from 'lucide-react'
      ...
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Manage community members, roles, and permissions</p>
          </div>
          ...
          <TabsContent value="members" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  View and manage member roles in Community {selectedCommunityId}
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {filteredMembers.map((member) => (
                    <div key={member.id} className="flex items-center justify-between p-4 border rounded-lg">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <RequirePermission communityId={selectedCommunityId} permission="remove_members">
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Are you sure you want to remove {member.user.first_name} {member.user.last_name} from this community? This action cannot be undone.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancel</AlertDialogCancel>
                                <AlertDialogAction onClick={() => removeMember(member.id)} className="bg-red-600 hover:bg-red-700">
                                  Remove
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
                  ...
                  {availableRoles.map((role) => (
                    <div key={role.id} className="p-4 border rounded-lg">
                      ...
                      <div className="text-sm">
                        <span className="font-medium">Example permissions: </span>
                        <span className="text-gray-600">
                          {role.role === 'Kurucu' && 'All permissions'}
                          {role.role === 'Yönetici' && 'Manage events, members, content moderation'}
                          {role.role === 'Moderatör' && 'Content moderation, basic member management'}
                          {role.role === 'Üye' && 'View community, participate in events'}
                        </span>
                      </div>
                    </div>
                  ))}
