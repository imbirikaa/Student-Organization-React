  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col items-center justify-center text-center mb-16">
        ...
        <p className="text-gray-400 mb-6">Hoş Geldiniz</p>
        <h1 className="text-5xl font-bold mb-6">ÖĞRENCİ TEŞKİLATI</h1>
        <p className="text-xl text-gray-300 max-w-2xl mb-8">
          Türkiye'nin en büyük kampüs topluluğuna katılın. Etkinlikler,
          topluluklar ve daha fazlası için tek adres.
        </p>
        <div className="flex flex-wrap gap-4 justify-center">
          <Button className="bg-teal-500 hover:bg-teal-600 rounded-full px-6">
            Konu Aç
          </Button>
          <Link href="/topluluklar">
            <Button
              variant="outline"
              className="rounded-full border-teal-500 text-teal-500 hover:bg-teal-500/10 px-6"
            >
              Toplulukları Keşfet
            </Button>
          </Link>
      ...
      <div className="bg-gray-900 rounded-lg p-8 mb-16">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-gray-300 mb-6">
            E-posta listemize kaydolun ve en yeni etkinlikler, topluluklar ve
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">info@ogrenciteskilati.com</span>
              </li>
              <li className="flex items-start">
                <span className="text-teal-500 mr-2">●</span>
